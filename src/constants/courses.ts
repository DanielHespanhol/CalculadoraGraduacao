...
export const IBG_COURSES: Course[] = [
  { id: 'direito', name: 'Direito', creditValue: 1446.21, discounts: { vestibular: [40, 55], transferencia: [45, 60], seJoga: [50, 60], convenio: 60, imperdivel: { value: 900.26, installments: 72 } } },
