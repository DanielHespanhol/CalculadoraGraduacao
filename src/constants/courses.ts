...
export const EAD_COURSES: EADCourse[] = [
  { id: 'ead-adm', name: 'Administração', monthlyValue: 743.00, installments: 48, imperdivelInstallments: 60, discounts: { vestibular: [50, 55, 60], transferencia: [55, 60, 65], seJoga: [80, 80, 80], convenio: [65, 65, 65], imperdivel: [64.44, 64.44, 64.44] }, notes: 'Com reajuste anual na campanha Imperdível' },
  ...
  { id: 'ead-ads', name: 'Análise e Desenvolvimento de Sistemas', monthlyValue: 743.00, installments: 30, imperdivelInstallments: 36, discounts: { vestibular: [50, 55, 60], transferencia: [55, 60, 65], seJoga: [80, 80, 80], convenio: [65, 65, 65], imperdivel: [63.35, 63.35, 63.35] }, notes: 'Com reajuste anual na campanha Imperdível' },
  { id: 'ead-ciencias-aero', name: 'Ciências Aeronáuticas - Live', monthlyValue: 1656.00, installments: 42, imperdivelInstallments: 50, discounts: { vestibular: [50, 55, 60], transferencia: [55, 60, 65], seJoga: [80, 80, 80], convenio: [65, 65, 65], imperdivel: [58.61, 58.61, 58.61] }, notes: 'Com reajuste anual na campanha Imperdível' },
  { id: 'ead-ciencias-contab', name: 'Ciências Contábeis', monthlyValue: 743.00, installments: 48, imperdivelInstallments: 60, discounts: { vestibular: [50, 55, 60], transferencia: [55, 60, 65], seJoga: [80, 80, 80], convenio: [65, 65, 65], imperdivel: [64.56, 64.56, 64.56] }, notes: 'Com reajuste anual na campanha Imperdível' },
  ...
  { id: 'ead-gestao-ti', name: 'Gestão da Tecnologia da Informação', monthlyValue: 743.00, installments: 30, imperdivelInstallments: 36, discounts: { vestibular: [50, 55, 60], transferencia: [55, 60, 65], seJoga: [80, 80, 80], convenio: [65, 65, 65], imperdivel: [63.35, 63.35, 63.35] }, notes: 'Com reajuste anual na campanha Imperdível' },
  { id: 'ead-gestao-qualidade', name: 'Gestão da Qualidade', monthlyValue: 743.00, installments: 24, imperdivelInstallments: 30, discounts: { vestibular: [50, 55, 60], transferencia: [55, 60, 65], seJoga: [80, 80, 80], convenio: [65, 65, 65], imperdivel: [64.44, 64.44, 64.44] }, notes: 'Com reajuste anual na campanha Imperdível' },
  { id: 'ead-gestao-financeira', name: 'Gestão Financeira', monthlyValue: 743.00, installments: 24, imperdivelInstallments: 30, discounts: { vestibular: [50, 55, 60], transferencia: [55, 60, 65], seJoga: [80, 80, 80], convenio: [65, 65, 65], imperdivel: [67.25, 67.25, 67.25] }, notes: 'Com reajuste anual na campanha Imperdível' },
  ...
  { id: 'ead-gestao-comercial', name: 'Gestão Comercial', monthlyValue: 743.00, installments: 24, imperdivelInstallments: 30, discounts: { vestibular: [50, 55, 60], transferencia: [55, 60, 65], seJoga: [80, 80, 80], convenio: [65, 65, 65], imperdivel: [67.25, 67.25, 67.25] }, notes: 'Com reajuste anual na campanha Imperdível' },
  { id: 'ead-producao-ind', name: 'Gestão da Produção Industrial', monthlyValue: 743.00, installments: 36, imperdivelInstallments: 40, discounts: { vestibular: [50, 55, 60], transferencia: [55, 60, 65], seJoga: [80, 80, 80], convenio: [65, 65, 65], imperdivel: [60.40, 60.40, 60.40] }, notes: 'Com reajuste anual na campanha Imperdível' },
  { id: 'ead-rh', name: 'Gestão de Recursos Humanos', monthlyValue: 743.00, installments: 24, imperdivelInstallments: 30, discounts: { vestibular: [50, 55, 60], transferencia: [55, 60, 65], seJoga: [80, 80, 80], convenio: [65, 65, 65], imperdivel: [67.25, 67.25, 67.25] }, notes: 'Com reajuste anual na campanha Imperdível' },
  { id: 'ead-logistica', name: 'Logística', monthlyValue: 743.00, installments: 24, imperdivelInstallments: 30, discounts: { vestibular: [50, 55, 60], transferencia: [55, 60, 65], seJoga: [80, 80, 80], convenio: [65, 65, 65], imperdivel: [67.25, 67.25, 67.25] }, notes: 'Com reajuste anual na campanha Imperdível' },
  { id: 'ead-marketing', name: 'Marketing', monthlyValue: 743.00, installments: 24, imperdivelInstallments: 30, discounts: { vestibular: [50, 55, 60], transferencia: [55, 60, 65], seJoga: [80, 80, 80], convenio: [65, 65, 65], imperdivel: [67.25, 67.25, 67.25] }, notes: 'Com reajuste anual na campanha Imperdível' },
  { id: 'ead-processos-gerenciais', name: 'Processos Gerenciais', monthlyValue: 743.00, installments: 24, imperdivelInstallments: 30, discounts: { vestibular: [50, 55, 60], transferencia: [55, 60, 65], seJoga: [80, 80, 80], convenio: [65, 65, 65], imperdivel: [67.25, 67.25, 67.25] }, notes: 'Com reajuste anual na campanha Imperdível' },
  { id: 'ead-redes', name: 'Rede de Computadores', monthlyValue: 816.00, installments: 30, imperdivelInstallments: 36, discounts: { vestibular: [50, 55, 60], transferencia: [55, 60, 65], seJoga: [80, 80, 80], convenio: [65, 65, 65], imperdivel: [65.74, 65.74, 65.74] }, notes: 'Com reajuste anual na campanha Imperdível' },
  { id: 'ead-seguranca-info', name: 'Segurança da Informação', monthlyValue: 743.00, installments: 30, imperdivelInstallments: 36, discounts: { vestibular: [50, 55, 60], transferencia: [55, 60, 65], seJoga: [80, 80, 80], convenio: [65, 65, 65], imperdivel: [63.35, 63.35, 63.35] }, notes: 'Com reajuste anual na campanha Imperdível' },
].sort((a, b) => a.name.localeCompare(b.name));
